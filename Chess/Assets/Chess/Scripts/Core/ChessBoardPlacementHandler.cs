...
public sealed class ChessBoardPlacementHandler : MonoBehaviour {
    ...
    internal void Highlight(int row, int col, Color color) {
        ...
        var highlightObj = Instantiate(_highlightPrefab, tile.transform.position, Quaternion.identity, tile.transform);
        var sr = highlightObj.GetComponent<SpriteRenderer>();
